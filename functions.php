                    ...
                    'blog_posts_grid_section' => array(
                        ...
                        'sub_fields' => array(
                            ...
                            array(
                                ...
                                'label'         => 'Limiter la grille à certaines catégories',
                                ...
                                'load_terms'    => 0,
                                'return_format' => 'id',
                                'instructions'  => 'Vide = tous les articles. Limite les articles de la grille — fonctionne même sans les boutons de filtrage.',
                            ),
                            array(
                                ...
                                'min'           => -1,
                                'max'           => 100,
                                'instructions'  => 'Laissez vide (ou -1) pour afficher tous les articles.',
                            ),
                            array(
                                'key'           => 'field_blog_grid_show_filters',
                                'label'         => 'Afficher les boutons de filtrage',
                                'name'          => 'show_filters',
                                'type'          => 'true_false',
                                'default_value' => 1,
                                'ui'            => 1,
                                'instructions'  => 'Contrôle uniquement les boutons au-dessus de la grille. Ils n\'apparaissent que s\'il y a au moins 2 catégories à filtrer.',
                            ),
                            array(
    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            array(
                ...
                'ajax' => 0,
                'return_format' => 'value',
                'placeholder' => 'Automatique (Catégorie WP)',
                'required' => 0,
                'instructions' => 'Optionnel. Laissez vide pour utiliser automatiquement la catégorie WordPress de l\'article.',
            ),
            array(
